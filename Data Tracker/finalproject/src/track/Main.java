 ...
 * CODE INSTRUCTION:
 * There shouldn't be anything that needs to be done to include the xChart library that I used to graph data.
 * But I have included some notes on it in the comments of View.display_graph().
 * 
